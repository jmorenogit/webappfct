...
$siglas_ciclo = $_POST["siglas_ciclo"];
...
$sentencia = $mysqli->prepare("UPDATE ciclos SET siglas_ciclo=?, nombre_ciclo=?, familia_profesional=?, tipo_ciclo=?, horas_fct=?  WHERE clave_ciclo=?");
$sentencia->bind_param("ssssis", $siglas_ciclo, $nombre_ciclo, $familia_profesional, $tipo_ciclo, $horas_fct, $clave_ciclo);
$sentencia->execute();
