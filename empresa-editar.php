...
<main>
    ...
    <article>
        <section>
            <form action="empresa-editar-update.php" method="post">
                ...
                <label for="telefono">Telefono</label><input type="text" name="telefono" id="telefono" value="<?php echo $empresa['telefono'] ?>">
